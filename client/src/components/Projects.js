          ...
          <div className="row project-row">
              {/* <!-- PROJECTS --> */}
                ...
                <div className="row project-row">
                    ...
                    <div className="col box">
                      <a href="https://secret-falls-29125.herokuapp.com/" rel='noopener'>
                        ...
                        <div className="card-body">
                          ...
                          <a href="https://github.com/caitlinw29/mentor-monkey" rel="noopener" className="btn btn-primary project-btn">GitHub Repository</a>
                        </div>
                    </div>
                    {/* <!-- Dope Horoscope --> */}
                    <div className="col box">
                      ...
                      <div className="img-container">                        
                        <div className="live-demo">Live Demo</div>
                        <img src={dopeHoroscope} className="img card-img-top" alt="..."/>
                      </div>  
                    </a>  
                      <div className="card-body">
                  ...
                  {/* <!-- Weather Dashboard --> */}
                    <div className="col box">
                      <a href="https://stevenlof777.github.io/weather-dashboard/" rel="noopener">
                      <div className="img-container">
                        <div src={weatherDashboard} className="card-img-top img" alt="..."/>
                      </div> 
                    </a> 
                      <div className="card-body">
                          ...
                          <a href="https://github.com/StevenLof777/weather-dashboard" rel="noopener" className="btn btn-primary project-btn">GitHub Repository</a>
                        </div>
                    </div>
                    {/* <!-- Daily Planner --> */}
                    <div className="col box">
