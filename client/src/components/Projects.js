...
export default function Projects() {
  return (
    <img className="img" src={"../src/assets/MentorMonkey.png"}className="card-img-top" alt="Mentor Monkey Website"/>
    ...
    //                     <img class="img" src="../assets/MentorMonkey.png" className="card-img-top" alt="Mentor Monkey Website"/>
    //                     </div>
    //                   </a>
    ...
    //                   <div className="img-container">                        
    //                     <div className="live-demo">Live Demo</div>
    //                     <img className="img" src="assets\images\dope_horoscope.png" className="card-img-top" alt="..."/>
    //                   </div>  
    //                 </a>  
    //                   <div className="card-body">
    ...
    //                   <div className="img-container">
    //                     <div className="live-demo">Live Demo</div> 
    //                     <img className="img" src="./assets/weatherdashboard.PNG" className="card-img-top" alt="..."/>
    //                   </div> 
    //                 </a> 
    //                   <div className="card-body">
    ...
    //                   <div className="img-container"> 
    //                     <div className="live-demo">Live Demo</div>
    //                     <img className="img" src="assets\images\daily-planner.PNG" className="card-img-top" alt="Image of a Daily Planner"/>
    //                   </div>    
    //                 </a>  
    //                   <div className="card-body">
